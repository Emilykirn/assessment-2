...
const canWeDeliver = (zipCode) => {
    for(let i=0; i < deliveryAreaZipCodes.length; i++){
        if( deliveryAreaZipCodes[1] === zipCode){
            return `You are in our delivery zone!`
        } else {
            return `Sorry we cant deliver.`
        }
    }
}
console.log(canWeDeliver(342423))
...
//CODE HERE
// let deals.Title = deals.title.replace('15', '10')
...
const newDiscount = deals[0].title.replace('15', '10')
